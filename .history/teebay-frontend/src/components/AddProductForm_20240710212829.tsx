...
import { CREATE_PRODUCT } from "../queries/product.ts";
import { CATEGORIES } from "../queries/categories.ts";
    ...
    <>
      <div className="">
        <Button
          ...
          className="bg-green-500 text-white m-0"
        >
          Add Product
        </Button>
      </div>
            ...
            <>
              <div className="mb-4">
                ...
                <Select
                  ...
                  multiple
                >
                  {categ?.categories?.map((cat: Category) => (
